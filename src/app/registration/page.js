                ...
                <div>
                  <div className="bg-white xl:p-20 lg:p-14 md:p-10 p-8 w-full h-full flex flex-col justify-center">
                    ...
                    <form className="grid grid-cols-1 gap-y-5 ukp-inplb">
                      ...
                      <div className="relative">
                        <button type="button" onClick={toggleConfirmPasswordVisibility} className="absolute top-1/2 right-3 -translate-y-1/2 border-none bg-transparent">
                          <Image src={showConfirmPassword ? eyeOpen : eyeSlash} alt="Toggle password visibility" priority />
                        </button>
                        <input type={showConfirmPassword ? "text" : "password"} className="inputfild-style" placeholder=" " />
