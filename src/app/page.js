          ...
          <div className="container mx-auto">
            <div className="max-w-[510px] bg-black bg-opacity-55 text-white md:px-8 md:py-9 px-5 py-5 md:text-left text-center">
              ...
              <div className="md:space-x-4 md:space-y-0 space-y-4 md:block flex flex-col items-center">
                ...
                <Link href={bannerData?.know_more_button_url} className="outline-btn md:w-auto text-center md:text-left md:justify-start justify-center text-white border-white">{bannerData?.know_more_button_text}</Link>
              </div>
            </div>
          </div>
        </div>
