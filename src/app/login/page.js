                    ...
                    <form className="grid grid-cols-1 gap-y-5 ukp-inplb">
                      ...
                      <div className="relative flex items-center justify-between">
                        <div className='flex items-center'>
                          <input type="password" className="w-6 h-6 border border-solid border-[#CFD0D1] rounded-md" placeholder=" "/>
                          <p className='text-[#727272] font-normal text-sm pl-2'>Remember me<span className="text-[#F06B30]">*</span></p>
                        </div>
